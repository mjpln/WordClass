...
<html>
  <head>
	...
	<script type="text/javascript" src="./js/kbdatacity.js"></script>
  ...
  <body >
    <div >
    <span style="margin:10px 10px 10px 0px">知识条目:</span><input id="kbdata" type="text" readonly="readonly" editable="false" class="easyui-textbox" style="width:300px;"/><br/><br/>
