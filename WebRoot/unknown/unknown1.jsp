...
<html>
  ...
  <body >
    ...
    <span style="margin:10px 10px 10px 0px">归属地市:</span><textarea id ="cityname1" name="" cols="6" rows="6" readonly="readonly"  style="width:295px;font-size:12px;" ></textarea><br/><br/>
    <span style="margin:10px 10px 10px 0px">编辑地市:</span><input id="selLocal" style="width:300px;">
    <!--<span style="margin:10px 10px 10px 0px">编辑地市:</span><input id="selLocal" class="easyui-combotree" style="width:300px;">-->
    <a class="easyui-linkbutton"  plain="false" onclick="update1()">更新</a>
